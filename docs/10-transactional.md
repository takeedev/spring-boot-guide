# บทที่ 10: เจาะลึก @Transactional — all-or-nothing กับฐานข้อมูล
...
เชื่อมกับเรื่อง Bean ใน [บทที่ 9](09-bean-deep-dive.md): Spring **ไม่ได้**ฉีด `TransferService` ตัวจริงให้ Controller
...
⬅️ [บทที่ 9: เจาะลึก Bean](09-bean-deep-dive.md) | [🏠 สารบัญ](../README.md) | [บทที่ 11: จากโค้ดฝึกหัดสู่งานจริง](11-production-ready.md) ➡️
